...
class ResultCalculatorTest {
    ...
    @Test
    public void test_result_of_numbers_when_sum_is_two() {
    ...
    @Test
    public void test_result_of_numbers_when_all_values_are_same() {
    ...
    @Test
    public void test_result_of_numbers_when_2_and_3_are_different_from_1() {
    ...
    @Test
    public void test_result_of_numbers_when_2_and_3_are_different_from_1_but_sum_is_2() {
        assertThat(resultCalculator.calculateResult(new TicketLine(0, 1, 1)), is(10));
